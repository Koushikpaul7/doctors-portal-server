...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.bs61w.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
//
       ...
       * app.post('booking)// add anew booking
